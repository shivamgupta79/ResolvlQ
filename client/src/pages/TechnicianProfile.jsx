...
export default function TechnicianProfile() {
  ...
  if (!user || user.role !== 'technician') return <Navigate to="/dashboard" />;
  ...
  return (
    <div className="form-card card">
      ...
      <div style={{ marginBottom: 24, textAlign: 'center' }}>
        ...
        <div style={{ marginTop: 8 }}>
          {uploading ? (
            ...
            <p className="muted" style={{ fontSize: 12, margin: 0 }}>Click the camera icon to upload a photo</p>
          )}
        </div>

        <h2 style={{ margin: '10px 0 4px' }}>{form.name || user.name}</h2>
        <p className="muted" style={{ margin: 0 }}>{user.email}</p>
        <span className="pill pill-offline" style={{ marginTop: 8, display: 'inline-block' }}>
          Technician
        </span>
      </div>
      ...
      <form onSubmit={save}>
        ...
        <div>
          ...
          <p className="muted" style={{ fontSize: 12, margin: '4px 0 0' }}>
            When the admin assigns a complaint to you, a WhatsApp message will be sent to this number automatically.
          </p>
        </div>
        ...
        <div className="whatsapp-guide">
          ...
          <ol style={{ margin: 0, paddingLeft: 18, fontSize: 13, lineHeight: 1.8 }}>
            ...
            <li>
              Send <code>join &lt;sandbox-word&gt;</code> to <b>+1 415 523 8886</b>
            </li>
            <li>Wait for the confirmation reply from Twilio</li>
            <li>Enter your WhatsApp number above (with country code, e.g. +91…)</li>
            <li>Save — you'll now receive job alerts automatically!</li>
          </ol>
          <p style={{ margin: '10px 0 0', fontSize: 12, color: '#64748b' }}>
            The sandbox word is shown in the Twilio console under{' '}
            <b>Messaging → Try it out → Send a WhatsApp message</b>.
            Ask your admin for the sandbox word if you don't have Twilio access.
          </p>
        </div>

        {/* What you'll receive */}
        <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 14, padding: '14px 16px' }}>
          <p style={{ margin: '0 0 8px', fontWeight: 700, fontSize: 13, color: '#1d4ed8' }}>
            📨 What you'll receive on WhatsApp
          </p>
          <div style={{ fontSize: 13, color: '#1e40af', lineHeight: 1.7 }}>
            <p style={{ margin: 0 }}>🔧 <b>New Work Assignment — FixFlow</b></p>
            <p style={{ margin: '4px 0 0', color: '#475569' }}>
              Issue · Priority · Apartment · Resident name · Date · Time · Description
            </p>
          </div>
        </div>
      ...
      <div style={DANGER_ZONE_STYLE}>
        ...
        <p className="muted" style={{ margin: '0 0 0', fontSize: 13 }}>
